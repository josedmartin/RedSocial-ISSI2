...
const photoRenderer = {
        ...
        <div id="photo-card" class="card text-center">
            <a style="text-decoration: none; color: black;" href="profile.html?userId=${photo.userId}">
                <h6 style="text-align: left; color:white;"> 
                    <img class="profile-icon" src="/images/profile.png" alt="login"> 
                        @${photo.username}
                    <img class="bar-icons" src="/images/trending.png" alt="Trending-Logo">
                </h6>
            </a>
    ...
    asDetails: function (photo) {
        ...
        <p>Uploaded by <a href="">@${photo.username}</a> on ${photo.date}</p>
        <p>Score: -</p>
